...
proposed_by: "initial-design"
based_on_candidate: "v1.0.0-2026-04-01"
status: "approved"
approved_at: "2026-04-01T00:00:00Z"
change_summary: |
  Meta-Harness v2.0 全面重设计：
  - 新增第零层：Meta-Harness 自我认知（trace 记录、outcome 识别）
  - 新增第四层：创作质量标准（一致性检查清单、术语检查、风格四轴评估、文件放置决策树、规则清晰度标准）
  - 新增第五层：Meta-Harness 操作指令（会话管理、提案触发、候选安装）
  - 工作流扩展：每个流程新增质量维度标注和 harness_rule_ref
---
<!--
HARNESS-METADATA
candidate_id: v2.0.0-2026-04-01
